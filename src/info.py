...
class Info(commands.Cog):
    ...
    async def about(self, ctx: discord.Interaction):
        embed = discord.Embed(
            title="⚡ About Zephyr",
            description="✨ Zephyr is a Discord mainly bot created for the Capital Gaming server. This bot helps manage things like moderation, info, FAQ, and some fun things.",
